...
if (document.getElementById('si3').checked==true) {p3=1}
else {p3=0}

if (document.getElementById('p32').checked===true) {p4=1}
else {p4=0}
...
if (document.getElementById('p51').checked===true) {p7=1}
else {p7=0}

if (document.getElementById('p62').checked===true) {p8=1}
else {p8=0}
